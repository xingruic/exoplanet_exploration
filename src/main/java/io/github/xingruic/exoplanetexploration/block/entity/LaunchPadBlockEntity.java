package io.github.xingruic.exoplanetexploration.block.entity;
...
public class LaunchPadBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public LaunchPadBlockEntity(BlockPos position, BlockState state) {
		super(ExoplanetExplorationModBlockEntities.LAUNCH_PAD.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("launch_pad");
	}
